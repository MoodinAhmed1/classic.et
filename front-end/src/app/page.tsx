    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 transition-colors duration-300">
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">LinkShort</span>
          </div>
          <div className="flex items-center space-x-4">
            <ThemeToggle />
            <Link href="/login">
              <Button variant="ghost" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800">
                Sign In
              </Button>
            </Link>
            <Link href="/register">
              <Button className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-cyan-500 dark:to-blue-500 hover:from-blue-700 hover:to-indigo-700 dark:hover:from-cyan-600 dark:hover:to-blue-600">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/register">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-cyan-500 dark:to-blue-500 hover:from-blue-700 hover:to-indigo-700 dark:hover:from-cyan-600 dark:hover:to-blue-600 text-lg px-8 py-4">
                Start Shortening Free
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/login">
              <Button size="lg" variant="outline" className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 text-lg px-8 py-4">
                View Dashboard
              </Button>
            </Link>
          </div>
          ...
          {/* Demo Link */}
          <div className="mt-8 p-4 bg-white/50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">See it in action:</p>
            <div className="flex items-center justify-center space-x-2">
              <span className="text-lg font-mono text-blue-600 dark:text-cyan-400">linkshort.co/abc123</span>
              <span className="text-gray-400">→</span>
              <span className="text-sm text-gray-500 dark:text-gray-400">https://example.com/very-long-url-that-gets-shortened</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <Card className="bg-white/80 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 backdrop-blur-sm shadow-lg dark:shadow-gray-900/20 hover:shadow-xl transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-gray-900 dark:text-white">Custom Domains</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <CardDescription className="text-gray-600 dark:text-gray-300">
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Paste Your URL</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Customize & Shorten</h3>
            <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          {/* Pro Plan */}
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-cyan-900/50 dark:to-blue-900/50 border-blue-200 dark:border-cyan-500/30 relative backdrop-blur-sm shadow-xl dark:shadow-gray-900/20 transform scale-105">
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 py-20">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-cyan-600 dark:to-blue-600 rounded-2xl p-12 text-center text-white">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Privacy Policy</Link>
              <Link href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
